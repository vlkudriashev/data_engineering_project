## Общая информация о проекте
   В проекте разрабатывается прототип системы автоматизированного управления данными, которые будут собираться и храниться интернет-магазином. Архивные данные о клиентах и транзакциях интернет-магазина обрабатываются и заносятся в OLTP СУБД, а далее  Цель проекта - изучить различные технические аспекты реализации таких систем, включая работу с СУБД и оркестрацию контейнеров.
    
    
## Этапы решения задачи

* Разработать структуры баз данных на основе имеющихся данных.
* Импортировать исходные данные в OLTP систему управления базами данных (СУБД) Postgres.
 ...
 * Произвести первичную настройку Airflow:
        ...
        выполнить только пункты, указанные в "Setting the right Airflow user"
        дальнейшая настройка будет производиться через Docker-Compose.
...
* ### Source DB - Postgres.
    ...
    <img src="https://raw.githubusercontent.com/vlkudriashev/data_engineering_project/master/pics/csv_to_source.png" width=50%>
...
* ### Target DB - Clickhouse
    ...
    <img src="https://raw.githubusercontent.com/vlkudriashev/data_engineering_project/master/pics/project_structure.png" width=75%>
...
Визуализация зависимости задач ДАГа:

	<img src="https://raw.githubusercontent.com/vlkudriashev/data_engineering_project/master/pics/airflow_tasks.jpg" width=50%>
...
<img src="https://raw.githubusercontent.com/vlkudriashev/data_engineering_project/master/pics/products_tbl_evolution.jpg" width=50%>
